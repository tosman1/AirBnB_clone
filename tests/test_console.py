...
Unittest classes are listed below:
...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_all(self):
        help = ("Usage: all or all <class> or <class>.all()\n        "
                "Display string representations of all instances of a given"
